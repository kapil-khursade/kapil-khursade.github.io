    ...
    <div className="relative isolate px-6 lg:px-8 dark:bg-black">
      ...
      >
        <div
          ...
          className="relative left-[calc(50%+3rem)] aspect-1155/60 w-144.5 -translate-x-1/2 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)] sm:w-288.75"
        />
      </div>
      <FooterComponant />
    </div>
...
export default BackgroundComponant