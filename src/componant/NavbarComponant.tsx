...
function NavbarComponant() {
  ...
  return (
    <header className="w-full absolute inset-x-0 top-0 z-50 flex justify-center-safe">
      <nav
        aria-label="Global"
        className="w-2/3 flex items-center justify-between py-6 lg:px-8"
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <h5 className="text-1xl font-semibold tracking-tight text-balance text-gray-900 sm:text-2xl">
              Kapil Khursade
            </h5>
          </a>
        </div>
